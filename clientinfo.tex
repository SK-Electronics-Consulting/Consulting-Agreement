...
\newcommand{\clientname}{TBD}
\newcommand{\clientaddr}{TBD ADDRESS}
...
\newcommand{\contractenddate}{CONTRACT END DATE}  %enddate and endingdate are already used :(
...
\newcommand{\retaineramount}{20 hours}
