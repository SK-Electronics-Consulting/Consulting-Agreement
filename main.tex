...
\textbf{Client}: \clientname\ with a mailing address of \clientaddr\ ("Client").  
...
The Services shall commence on \effectivedate, and end
\iftoggle{fixedenddate}{
on the date of \contractenddate.
}
{
when termination e-mail is received with 7 days notice.  
}

\section{Compensation and Payment Method}
\label{section:compensation}
...
\begin{itemize}
    ...
    \item Purchases related to the project will be reimbused, along with a 15\% increase for handling. 
...
\iftoggle{retainer}
{
The client is required to pay a refundable retainer of \retaineramount\ before the Consultant is able to provide services.  If the retainer is to be refunded in part or in whole, the time spent planning and estimating for the project will be billed to the client at the normal hourly rate, including any purchases and fees that may have been incurred. 
}
{
...
{
% Open source clause
The design output of Consultant shall be open-sourced.  This includes reports, design files, softwares, assembly information, and documentation for implementing these.  These will be open-sourced under a license of the Consultant's choosing.  
}
{
% Closed source clause
